...
public class DemoBaseDatos
{
    ...
    {
        System.out.println("Hay en la BD un total de " + bd.totalDVD() + " DVD's");
    }
    ...
    {
        System.out.println("Duracóon total de CD " + bd.totalDuracionCD() + " minutos");
    }
    ...
    {
        System.out.println("Vídeos con formato " + formato + " " +  bd.videosConFormato(formato));
    }

    public static void main(String[] args) {
        DemoBaseDatos dbd = new DemoBaseDatos();
        dbd.demoAddArticulo();
        dbd.demoListar();
    }
